import "./chunk-ID5KMW2G.js";
import "./chunk-CLE7WWQ3.js";
import {
  check_target,
  derived,
  get,
  ...
  readable,
  writable
} from "./chunk-ZOXXVGZD.js";
import "./chunk-U7P2NEEE.js";
import {
  append,
  set_text,
  text
} from "./chunk-KUCX7UEB.js";
import {
  FILENAME,
  HMR,
  next,
...
// node_modules/tanstack-table-8-svelte-5/dist/placeholder.svelte
Placeholder[FILENAME] = "node_modules/tanstack-table-8-svelte-5/dist/placeholder.svelte";
function Placeholder($$anchor, $$props) {
  ...
  next();
  var text3 = text();
  template_effect(() => set_text(text3, $$props.content));
  append($$anchor, text3);
  return pop($$exports);
}
if (import.meta.hot) {
  Placeholder = hmr(Placeholder, () => Placeholder[HMR].source);
  import.meta.hot.accept((module) => {
    module.default[HMR].source = Placeholder[HMR].source;
    set(Placeholder[HMR].source, module.default[HMR].original);
  });
}
var placeholder_default = Placeholder;

// node_modules/tanstack-table-8-svelte-5/dist/index.js
function renderComponent(Comp, props) {
  return (anchor) => Comp(anchor, props);
}
function wrapInPlaceholder(content) {
  return renderComponent(placeholder_default, { content });
}
...
function createSvelteTable(options) {
  ...
  const tableReadable = readable(table, function start(set2) {
    const unsubscribe = stateOptionsStore.subscribe(([state, options2]) => {
      table.setOptions((prev) => {
        return {
          ...prev,
          ...options2,
          state: { ...state, ...options2.state },
...
@tanstack/table-core/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=tanstack-table-8-svelte-5.js.map
